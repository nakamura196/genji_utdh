...
Snorqldef = {
  ...
  vars: {
    ...
    _endpoint: 'https://dydra.com/i2k/genji/sparql',
    _poweredByLink: 'http://daijirin.dual-d.net/extra/genji.html',
    _poweredByLabel: '源氏物語の人物相関図',
    default_query:
  ...
  home: {
    label: '源氏物語の人物相関図',
    uri: 'http://daijirin.dual-d.net/extra/genji.html',
...
Snorqldef.example = [
  {
		...
		"label_en" : "集計・ランキング",
		"ns" : [ ],
		"query" : "SELECT ?name (count(?o) AS ?c)\nWHERE {\n	?s ex:hasChild ?o .\n	?s schema:name ?name .\n}\nGROUP BY ?name\nORDER BY DESC(?c)\n"
	}
]
